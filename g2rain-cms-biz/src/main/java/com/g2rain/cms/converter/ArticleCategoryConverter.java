...
public interface ArticleCategoryConverter {
     ...
     */
    ArticleCategoryConverter INSTANCE = Mappers.getMapper(ArticleCategoryConverter.class);
    ...
    ArticleCategoryVo po2vo(ArticleCategoryPo po);
    ...
    ArticleCategoryPo dto2po(ArticleCategoryDto dto);
}
